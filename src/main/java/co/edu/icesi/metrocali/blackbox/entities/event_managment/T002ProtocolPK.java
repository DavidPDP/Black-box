 ...
 */
@Embeddable
public class T002ProtocolPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof T002ProtocolPK)) {
			return false;
		}
		T002ProtocolPK castOther = (T002ProtocolPK)other;
		return 
