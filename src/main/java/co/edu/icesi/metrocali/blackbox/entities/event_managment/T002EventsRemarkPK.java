 ...
 */
@Embeddable
public class T002EventsRemarkPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof T002EventsRemarkPK)) {
			return false;
		}
		T002EventsRemarkPK castOther = (T002EventsRemarkPK)other;
		return 
